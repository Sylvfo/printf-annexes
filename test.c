...
//	printf("testpointer %d", )
	...
	printf("test petit 20 x %x \n", 20);
	printf("test petit 21 x %x \n", 21);
	printf("test petit 22 x %x \n", 22);
	printf("test petit 23 x %x \n", 23);
	printf("test petit 24 x %x \n", 24);
	printf("test petit 25 x %x \n", 25);
	printf("test petit 26 x %x \n", 26);
	printf("test petit 27 x %x \n", 27);	
	printf("test petit 28 x %x \n", 28);
	printf("test petit 29 x %x \n", 29);
	printf("test petit 30 x %x \n", 30);
	printf("test petit 31 x %x \n", 31);
	printf("test petit 32 x %x \n", 32);
	printf("test petit 33 x %x \n", 33);	
	printf("test petit 34 x %x \n", 34);
	printf("test petit 100 x %x \n", 100);
	printf("test petit 2023 x %x \n", 2023);
	printf("test petit 200 x %x \n", 200);
